...
<body>
	...
	<section class="all_user_info">
		<h1>
			<i class="fas fa-won-sign"></i> <a href="/resources/html/index.html">내
				주변 경기도 지역화폐 가맹점</a>
		</h1>
		<h2>회원 정보 수정</h2>
			...
			<div class="user_column">
				...
				<div class="error_area">
					<div class="box int_id">
						<input type="text" id="id" name="id" class="int" value="${user.id}" readonly />
			...
			<div class="user_column">
				...
				<div class="error_area">
					<div class="box int_pass">
						<input type="text" id="pwsd1" name="passWord"class="int" maxlength="20" value=""
							autocomplete="off" required /> <span id="alertTxt">사용불가</span> <img
							src="/resources/img/m_icon_pass.png" id="pswd1_img1" class="pswdImg" />
					</div>
