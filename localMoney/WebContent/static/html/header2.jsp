	...
	<div class="wrap_header">
		<nav class="navbar">
			...
			<ul class="navbar_menu">
				...
				<li><a href="/home/mypage" id="nav_my_page">회원 정보</a></li>
			</ul>
			<!-- 프로필 부분 -->
			<div class="user_area">
				<div class="wrap_user">
				...
				<div class="user_menu">
					<c:if test="${user!=null}">
						...
						<span>${user.name}</span>
						<div class="log-out">
							<button class="btn_log_out" onclick="location.href='../home/logout'">
					...
					<c:if test="${user==null}">
						...
						<span>${user.name}</span>
						<div class="log-out">
							<button class="btn_log_out" onclick="location.href='../home/LoginPage'">
